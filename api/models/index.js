...
const Levels = sequelize.define('levels', {
  ...
  status: { type: DataTypes.ENUM('unlocked','locked','completed'), defaultValue: 'locked' },
  score: { type: DataTypes.INTEGER, defaultValue: 0 },
  time_spent: { type: DataTypes.INTEGER, defaultValue: 0 }
}, { timestamps: false });

const Dinos = sequelize.define('dinos', {
...
module.exports = { sequelize, models: { Players, Levels, Dinos, Questions, Answers } };
